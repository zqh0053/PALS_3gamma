...
class Dso():
    def __init__(self,parameters):
        ...
        self.dso.WriteString("C3:OFST 1.2", 1)
    ...
    def get_wave(self):
        ...
        c3_waveform_0 = self.dso.GetScaledWaveformWithTimes("C3", 200000, 0)
        c3_waveform_time = np.array(c3_waveform_0[0])
        c3_waveform_v = np.array(c3_waveform_0[1])
        if self.parameters['polarity'] == 'negative':
            ...
            c3_waveform_v = c3_waveform_v * -1.
            c3_waveform_time = c3_waveform_time * 1000000000
        waveform = {}
        c1_waveform = [c1_waveform_time.tolist(), c1_waveform_v.tolist()]
        c2_waveform = [c2_waveform_time.tolist(), c2_waveform_v.tolist()]
        c3_waveform = [c3_waveform_time.tolist(), c3_waveform_v.tolist()]
        if self.parameters['SEQ'] == 'ON':
            ...
            c3_waveform[0] = [c3_waveform[0][i:i + n] for i in range(0, len(c3_waveform[0]), n)]
            c3_waveform[1] = [c3_waveform[1][i:i + n] for i in range(0, len(c3_waveform[1]), n)]
